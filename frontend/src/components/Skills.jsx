      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {skills.map((skill, index) => {
            ...
            return (
              <ScrollReveal key={skill.id} direction={direction}>
                <article className="flex flex-col items-center rounded-lg bg-second p-8 shadow-md transition-transform duration-300 hover:-translate-y-1">
